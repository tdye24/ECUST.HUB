			...
			if(!loginresult.havelogan) {
				...
				$.ajax({
					...
					success: function(info) {
						...
						$.ajax({
							url: 'http://localhost:3000/query/mycomments',
							type: 'get',
							dataType: 'json',
								...
								$.ajax({
									...
									success: function(like_list) {
										...
										$('img.delete').off().on('click', function(e) {
											...
											let parentnode = 
											$.ajax({
												url: 'http://localhost:3000/update/delete_comment',
												type: 'get',
												dataType: 'json',
